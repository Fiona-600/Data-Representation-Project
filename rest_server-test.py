...
# create
# curl -X POST -d '{\"ID\":\"BOF1\",\"Class_Name\":\"Beginners-Obedience\",\"Day\":\"Friday\", \"Time\":\"6pm\", \"Max_Participants\":10, \"Trainer\":\"Orla\"}' -H Content-Type:application/json http://127.0.0.1:5000/Classes
# curl -X POST -d "{\"Title\":\"test\", \"Author\":\"some guy\", \"Price\":123}" http://127.0.0.1:5000/books
# curl -X POST -d "{\"ID\":\"BOFI\",\"Class_Name\":\"Beginners-Obedience\",\"Day\":\"Friday\", \"Time\":\"6pm\", \"Max_Participants\":10, \"Trainer\":\"Orla\"}" -H Content-Type:application/json http://127.0.0.1:5000/Classes
